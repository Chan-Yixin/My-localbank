package sg.edu.rp.c346.id22038283.mylocalbank;
    ...
    public boolean onContextItemSelected(MenuItem item) {
        if (wordClicked.equalsIgnoreCase("dbs")) {
            if (item.getItemId() == 0) {
                ...
                btnOne.setTextColor(Color.parseColor(getString(R.string.red)));
            }
        } else if (wordClicked.equalsIgnoreCase("ocbc"))
        {
            if (item.getItemId() == 0) {
                ...
                btnTwo.setTextColor(Color.parseColor(getString(R.string.red)));
            }
        }
        else if (wordClicked.equalsIgnoreCase("uob"))
        {
            if (item.getItemId() == 0) {
                ...
                btnThree.setTextColor(Color.parseColor(getString(R.string.red)));
            }
        }
